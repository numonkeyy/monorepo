...
test("should use branches correctly", async () => {
	...
	await lix.createBranch("test_branch", { branchId: "test_branch" });
	...
	await lix.createBranch("test_branch_2", { branchId: "test_branch_2" });
	...
	await lix.switchBranch({ name: "test_branch_2" });
